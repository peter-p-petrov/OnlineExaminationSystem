<%@ Page Title="Тест" Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="Questions.aspx.cs" Inherits="Questions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <table width="560" align="center">
            <tr>
                <td class="h1"><span class="style2">Име на тест:</span>&nbsp;
            ...
            <tr>
                <td>
                    <asp:DetailsView ID="questionDetails" runat="server" Height="50px" Width="550px" AutoGenerateRows="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                        ...
                        <Fields>
                            <asp:BoundField DataField="QuestionOrder" HeaderText="Въпрос номер:" />
            ...
            <tr>
                <td class="boldtext">
                    <span class="style1">Избери отговор:</span>&nbsp;
                <asp:DropDownList ID="ddlAnswer" runat="server">
                            <asp:ListItem Value="1">Отговор 1</asp:ListItem>
                            <asp:ListItem Value="2">Отговор 2</asp:ListItem>
                            <asp:ListItem Value="3">Отговор 3</asp:ListItem>
                            <asp:ListItem Value="4">Отговор 4</asp:ListItem>
                        </asp:DropDownList>
                </td>
            </tr>
            <tr>
