<%@ Page Title="Резултат" Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="Results.aspx.cs" Inherits="Results" %>
                ...
                <td>
                    ...
                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="resultGrid_SelectedIndexChanged" Width="555px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CorrectAnswer" HeaderText="Правилен отговор" />
                ...
                <td>
                    <asp:DetailsView ID="answerDetails" runat="server" CellPadding="4" ForeColor="#333333"
                        ...
                        <Fields>
                            ...
                            <asp:BoundField DataField="CorrectAnswer" HeaderText="Правилен отговор:" />
                            <asp:BoundField DataField="AnswerExplanation" HeaderText="Обяснение:" />
                        </Fields>
                    </asp:DetailsView>                
                </td>
            </tr>
            <tr>
                <td><a href="Exam.aspx">Върнете се към главното меню</a></td>
            </tr>                                    
        </table>
</asp:Content>
